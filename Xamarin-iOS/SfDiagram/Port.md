...
description: Briefs about port ,connection with node and its customization in Syncfusion<sup>&reg;</sup>; Diagram (SfDiagram) control for Xamarin.iOS
...
{% endhighlight %}
{% endtabs %}
![Port in Xamarin.iOS diagram](Port_images/Port_img1.jpeg)
