...
* [`SFChartLabelContent.Percentage`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartLabelContent.html#Syncfusion_SfChart_iOS_SFChartLabelContent_Percentage) – This will show the percentage value of corresponding data point Y value, this is often used in pie, doughnut, funnel and pyramid series types.
* [`SFChartLabelContent.YValues`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartLabelContent.html#Syncfusion_SfChart_iOS_SFChartLabelContent_YValue) – This will show the corresponding Y value (Default).
...
The [`LabelPosition`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFDataMarkerLabelStyle.html#Syncfusion_SfChart_iOS_SFDataMarkerLabelStyle_LabelPosition) property is used to position the data marker labels at [`Center`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerLabelPosition.html#Syncfusion_SfChart_iOS_SFChartDataMarkerLabelPosition_Center), [`Inner`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerLabelPosition.html#Syncfusion_SfChart_iOS_SFChartDataMarkerLabelPosition_Inner) and [`Outer`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerLabelPosition.html#Syncfusion_SfChart_iOS_SFChartDataMarkerLabelPosition_Outer) position of the actual data point position. By default, labels are positioned based on the series types for better readability. You can move the labels horizontally and vertically using [`OffsetX`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFDataMarkerLabelStyle.html#Syncfusion_SfChart_iOS_SFDataMarkerLabelStyle_OffsetX) and [`OffsetY`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFDataMarkerLabelStyle.html#Syncfusion_SfChart_iOS_SFDataMarkerLabelStyle_OffsetY) properties respectively.
...
N> For Pie and Doughnut series, you can set the [`Bezier`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartConnectorLineType.html#Syncfusion_SfChart_iOS_SFChartConnectorLineType_Bezier) curve for connector line using [`ConnectorLineType`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFCircularSeries.html#Syncfusion_SfChart_iOS_SFCircularSeries_ConnectorLineType) property of Pie and Doughnut series.

## Event

### DataMarkerLabelCreated

The [`DataMarkerLabelCreated`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFSeries.html#Syncfusion_SfChart_iOS_SFSeries_DataMarkerLabelCreated) event occurs when the data marker label is created. This argument contains object of the [`DataMarkerLabel`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.DataMarkerLabel.html). The following properties are available in DataMarkerLabel to customize the appearance of data markers based on condition.
...
* [`MarkerType`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.DataMarkerLabel.html#Syncfusion_SfChart_iOS_DataMarkerLabel_MarkerType) – Gets or sets the shape type of marker. The available shapes are [`Ellipse`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Ellipse), [`Diamond`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Diamond), [`Hexagon`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Hexagon), [`Cross`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Cross), [`HorizontalLine`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Cross), [`VerticalLine`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_VerticalLine), [`InvertedTriangle`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_InvertedTriangle), [`Triangle`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Triangle), [`Pentagon`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Pentagon), [`Plus`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Plus), and [`Square`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartDataMarkerType.html#Syncfusion_SfChart_iOS_SFChartDataMarkerType_Square).
...
* [`GrandTotal`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.DataMarkerLabel.html#Syncfusion_SfChart_iOS_DataMarkerLabel_GrandTotal) - Gets the sum of y-values data.
