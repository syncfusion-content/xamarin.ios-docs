...
[`WillDataPointSelect`](https://help.syncfusion.com/cr/cref_files/xamarin-ios/sfchart/Syncfusion.SFChart.iOS~Syncfusion.SfChart.iOS.SFChartDelegate~WillDataPointSelect.html) is called when the series datapoint selection operation has been started and it returns the following values.
...
[`DidDataPointSelect`](https://help.syncfusion.com/cr/cref_files/xamarin-ios/sfchart/Syncfusion.SFChart.iOS~Syncfusion.SfChart.iOS.SFChartDelegate~DidDataPointSelect.html) is called when the series datapoint selection operation has been finished and it returns the following values.
