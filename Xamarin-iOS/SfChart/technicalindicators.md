...
Also you can draw [`Line`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFChartMACDType.html#Syncfusion_SfChart_iOS_SFChartMACDType_Line), Histogram MACD or Both using the [`MACDType`](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.SfChart.iOS.SFMACDIndicator.html#Syncfusion_SfChart_iOS_SFMACDIndicator_MACDType) property, which defines the type of MACD to be drawn.
