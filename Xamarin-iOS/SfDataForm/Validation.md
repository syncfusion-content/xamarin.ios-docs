...
## IPropertyValue Converter

To show the original value in different format or as different value, use the [Converter](https://help.syncfusion.com/cr/cref_files/xamarin-ios/sfdataform/Syncfusion.SfDataForm.iOS~Syncfusion.iOS.DataForm.ConverterAttribute.html) attribute. [IPropertyValueConverter](https://help.syncfusion.com/cr/cref_files/xamarin-ios/sfdataform/Syncfusion.SfDataForm.ios~Syncfusion.ios.DataForm.IPropertyValueConverter_members.html) represents the interface to provide the method for converting the value.

Here, the original value (20) is converted to different value (40) in the view, by multiplying the original value by 2.
