---
layout: post
title: Validation | SfDataForm | Xamarin.iOS | Syncfusion<sup>&reg;</sup>
...
[ValidationMode](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.SfDataForm.html#Syncfusion_iOS_DataForm_SfDataForm_ValidationMode) determines when the value should be validated.
...
Value should be validated manually by calling [SfDataForm.Validate](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.SfDataForm.html#Syncfusion_iOS_DataForm_SfDataForm_Validate().html) or [SfDataForm.Validate (propertyName)](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.SfDataForm.html#Syncfusion_iOS_DataForm_SfDataForm_Validate(String).html) method.
...
You can validate the data using [Validating](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.SfDataForm.html) event of SfDataForm.
...
You can get the notification after completing validation using [Validated](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.SfDataForm.html) event of SfDataForm.
...
If the value meets the desired criteria, you can show [valid or positive message](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.DisplayOptionsAttribute.html#Syncfusion_iOS_DataForm_DisplayOptionsAttribute_ValidMessage).  Like error message, valid message also will be displayed in the bottom of the editor.
...
You can use custom [DataFormLayoutManager](https://help.syncfusion.com/cr/xamarin-android/Syncfusion.Android.DataForm.DataFormLayoutManager.html) class to customize validation message by overriding [UpdateViewForValidation](https://help.syncfusion.com/cr/xamarin-ios/Syncfusion.iOS.DataForm.DataFormLayoutManager.html#Syncfusion_iOS_DataForm_DataFormLayoutManager_UpdateViewForValidation_Syncfusion_iOS_DataForm_DataFormItem_CoreGraphics_CGRect_) method. It lets you to return different custom views for each validation message based on certain conditions.
