...
# Downloading Syncfusion Xamarin.iOS web installer
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion Essential Studio® Xamarin.iOS web installer.
...
8. After downloading, the Syncfusion Xamarin.iOS web installer can be unlocked using Syncfusion registered login credential.
