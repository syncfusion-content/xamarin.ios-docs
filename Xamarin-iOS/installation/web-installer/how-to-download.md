...
# Downloading Syncfusion<sup>®</sup> Xamarin.iOS web installer
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> Xamarin.iOS web installer.
...
4. After you've started the trial, go to the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page to get the latest version trial installer. You can generate the [unlock key](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) and [license key](https://help.syncfusion.com/xamarin-ios/licensing/how-to-generate) here at any time before the trial period expires. (as shown in below screenshot.)
...
8. After downloading, the Syncfusion<sup>®</sup> Xamarin.iOS web installer can be unlocked using Syncfusion<sup>®</sup> registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/xamarin-ios/installation/web-installer/how-to-install) links for step-by-step installation guidelines.	