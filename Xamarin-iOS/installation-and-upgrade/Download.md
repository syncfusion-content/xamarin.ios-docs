...
The Syncfusion Xamarin installer can be downloaded from the [Syncfusion](https://www.syncfusion.com/xamarin-ui-controls) website.
...
2. After completing the required form or logging in with your registered Syncfusion account, you can download the Xamarin installer from the confirmation page. (as shown in below screenshot.) 
...
7. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio Xamarin Offline installer which is available in EXE and ZIP format.
...
7. For Windows OS, EXE and Zip formats are available for download. They are both Offline Installers.
   ...
   For more information, please see [this](https://help.syncfusion.com/xamarin-ios/licensing/licensing) help topic.
