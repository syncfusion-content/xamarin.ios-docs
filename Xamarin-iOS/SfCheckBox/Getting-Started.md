...
## Setting caption
The check box caption can be defined using `SetTitle` method of `SfCheckBox`. This caption normally describes the meaning of the check box and it displays next to check box.
