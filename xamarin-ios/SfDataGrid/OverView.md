...
N> Xamarin.Forms is unique in this space by offering a single language – C# and runtime that works across all three mobile platforms of iOS, Android, and UWP. So SfDataGrid for Xamarin.Forms works in all three platforms.
