...
N> When BeginInit method is called it suspends all the updates until EndInit method is called.So grouping is not being applied between SfDataGrid.View.BeginInit() and SfDataGrid.View.EndInit().
